              ...
              <div className="flex flex-col items-center w-full">
                ...
                <div className="flex items-center gap-1 mt-2">
                  ...
                  <div className="relative group">
                    ...
                    <span className="absolute left-7 -translate-x-1/2 -top-8 scale-0 group-hover:scale-100 transition-transform duration-200 bg-gray-7 dark:bg-gray-3 dark:text-gray-8 text-whitee text-xs px-2 py-1 rounded-sm shadow-md">
                      Verified
                    </span>
                  </div>
                </div>
