                    ...
                    <button
                      ...
                      className={`w-full cursor-pointer flex items-center space-x-3 px-3.5 pt-[7px] pb-[10px] rounded-lg rounded-r-sm transition-all duration-300 ${
                        isActive
                          ...
                          : 'bg-transparent text-gray-7/80 hover:text-gray-7 dark:text-gray-2/60 dark:hover:text-gray-1 hover:bg-gray-2/60 dark:hover:bg-gray-5/20 hover:scale-[103%] transition-color duration-300'
                      }`}
                    >
