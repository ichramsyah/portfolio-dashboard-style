    ...
    <>
      ...
      <div className={`fixed left-0 top-0 h-full w-68 bg-whitee px-7 py-7 dark:bg-gray-9 z-50 transform transition-all ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
        <div className="flex flex-col h-full">
          <div className="pb-5 border-b border-gray-2 dark:border-gray-7 relative">
            <div className="flex items-center justify-between">
              <motion.div
                ...
                viewport={{ once: false }}
                className="flex flex-col items-center w-full mt-4" // Menggunakan flex-col dan items-center
              >
                {/* Gambar Profil */}
                <img src="./images/ppinstagram.png" alt="" className="w-20 h-20 object-cover rounded-full border-2 dark:border-gray-700" />

                {/* Grup Nama & Ikon */}
                <div className="flex items-center gap-1 mt-4">
                  <h1 className="text-xl text-gray-9 dark:text-whitee">Ichramabdr</h1>
