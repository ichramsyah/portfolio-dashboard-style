...
const Sidebar = ({ activeSection, setActiveSection, isMobileMenuOpen, setIsMobileMenuOpen }) => {
  ...
  return (
    <>
      ...
      <div className={`fixed left-0 top-0 h-full w-68 bg-whitee px-7 py-7 dark:bg-background-dark z-50 transform transition-all duration-350 ease-in-out ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
