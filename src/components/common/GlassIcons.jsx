const colorClassMapping = {
  ...
  django: 'bg-gradient-to-br from-green-600 to-green-900',
  ...
  aws: 'bg-gradient-to-br from-gray-900 via-orange-700 to-yellow-500',
  linux: 'bg-gradient-to-br from-gray-300 to-yellow-600',
  ubuntu: 'bg-gradient-to-br from-orange-500 to-orange-600',
  apache: 'bg-gradient-to-br from-purple-800 to-orange-800',
  ...
  git: 'bg-gradient-to-br from-red-500 via-red-600 to-red-700',
  github: 'bg-gradient-to-br from-gray-800 to-gray-900',
  postman: 'bg-gradient-to-br from-orange-500 to-orange-300',
  figma: 'bg-gradient-to-br from-gray-900 to-gray-700',
  adobeillustrator: 'bg-gradient-to-br from-orange-900 via-orange-800 to-orange-700',
  adobephotoshop: 'bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700',
  cpanel: 'bg-gradient-to-br from-orange-500 to-orange-600',
