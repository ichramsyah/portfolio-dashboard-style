...
const SectionHeader = ({ title, description }) => {
  return (
    <div className="pb-8 mb-5 border-b border-gray-3 dark:border-gray-7">
      <motion.h1 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.7, ease: 'easeOut', delay: 0.1 }} viewport={{ once: true }} className="text-3xl font-medium text-gray-9 dark:text-gray-3 mb-3">
        {title}
      </motion.h1>
