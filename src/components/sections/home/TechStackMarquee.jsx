...
const iconMap = {
  ...
  Gunicorn: <img src="https://www.svgrepo.com/show/353846/gunicorn.svg" alt="Gunicorn" className="w-[22px] " />,
  Pm2: <img src="https://cdn.simpleicons.org/pm2" alt="Pm2" className="w-[22px] " />,
