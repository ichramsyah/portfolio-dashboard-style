...
const FilterButtons = ({ categoryFilter, setCategoryFilter, categories, categoryIcons, t }) => {
  ...
  return (
    <div ref={containerRef} className="relative flex flex-wrap gap-3">
      <motion.div animate={underlineStyle} transition={{ type: 'spring', stiffness: 400, damping: 30, duration: 1 }} layout className="absolute bottom-0 md:h-full h-0 rounded-sm bg-blue-3 dark:bg-blue-4" />
