    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
      ...
      <div class="relative grid w-full grid-cols-[2.5fr_1fr] overflow-hidden rounded-md p-6 md:col-span-2  bg-gradient-to-b from-red-700 to-red-900">
        ...
        <div class="text-red-300 z-10 flex flex-col justify-between gap-y-2">
          ...
          <a href="mailto:ichramsyahabdurrachman@gmail.com" target="_blank" class="bg-red-300 rounded-md bg-opacity-85 px-4 py-2 transition duration-100 hover:bg-opacity-100 md:w-max ">
      ...
      {/* Instagram */}
      <div class="relative grid w-full grid-cols-[2.5fr_1fr] overflow-hidden rounded-md p-6 undefined  bg-gradient-to-b from-purple-700 via-pink-500 to-orange-500">
        ...
        <div class="text-purple-200 z-10 flex flex-col justify-between gap-y-2">
          ...
          <button class="bg-purple-200 rounded-md bg-opacity-85 px-4 py-2 transition duration-100 hover:bg-opacity-100 md:w-max ">
            <a target="_blank" class="flex items-center justify-center gap-x-2  text-black" href="https://www.instagram.com/ichramabdr/">
      ...
      <div class="relative grid w-full grid-cols-[2.5fr_1fr] overflow-hidden rounded-md p-6 undefined  bg-gradient-to-b from-sky-700 to-sky-900">
        ...
        <div class="text-sky-300 z-10 flex flex-col justify-between gap-y-2">
          ...
          <button class="bg-sky-300 rounded-md bg-opacity-85 px-4 py-2 transition duration-100 hover:bg-opacity-100 md:w-max ">
            <a target="_blank" class="flex items-center justify-center gap-x-2  text-black" href="https://www.linkedin.com/in/ichramsyah-abdurrachman-49a131280/">
              <p class="text-sm font-medium">
      ...
      <div class="relative grid w-full grid-cols-[2.5fr_1fr] overflow-hidden rounded-md p-6 undefined  bg-gradient-to-b from-neutral-700 to-neutral-900">
        ...
        <div class="text-neutral-400 z-10 flex flex-col justify-between gap-y-2">
          ...
          <button class="bg-neutral-400 rounded-md bg-opacity-85 px-4 py-2 transition duration-100 hover:bg-opacity-100 md:w-max ">
            <a target="_blank" class="flex items-center justify-center gap-x-2  text-black" href="https://www.tiktok.com/@diakuaku/">
              <p class="text-sm font-medium">
      ...
      <div class="relative grid w-full grid-cols-[2.5fr_1fr] overflow-hidden rounded-md p-6 undefined  bg-gradient-to-b from-slate-900 to-slate-950">
        ...
        <div class="text-slate-400 z-10 flex flex-col justify-between gap-y-2">
          ...
          <button class="bg-slate-400 rounded-md bg-opacity-85 px-4 py-2 transition duration-100 hover:bg-opacity-100 md:w-max ">
            <a target="_blank" class="flex items-center justify-center gap-x-2  text-black" href="https://github.com/ichramsyah">
              <p class="text-sm font-medium">
