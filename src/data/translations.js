...
I am eager to contribute to the technology industry with innovative web solutions. Let’s connect to collaborate or explore opportunities together!`,
  ...
  id: {
    ...
    home: {
      ...
      description:
        'Pengembang Fullstack berpengalaman dan bersemangat dengan fokus pada pengembangan end-to-end. Terbiasa bekerja secara kolaboratif dalam tim dan berkomitmen untuk membangun aplikasi web yang fungsional, responsif, dan menarik secara visual. Di sisi frontend, saya bekerja dengan React.js, Next.js, TypeScript, dan Tailwind CSS untuk menciptakan antarmuka pengguna yang responsif dan mudah diakses. Di sisi backend, saya menggunakan Node.js, Express.js, Laravel, MySQL, dan MongoDB untuk membangun API yang kuat dan mengelola data secara efektif.',
      skills: 'Keahlian',
      skills_paragraph: 'Keahlian profesional saya.',
      githubcontribution: 'Kontribusi GitHub',
      githubcontribution_paragraph: 'Aktivitas GitHub saya selama satu tahun terakhir.',
      githubcontribution_week: 'Minggu ini',
